...
public class MainActivity extends AppCompatActivity {
    ...
    protected SeekBar rabbit_seeBar,tortoise_seeBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rabbit_seeBar = (SeekBar) findViewById(R.id.rabbit_seekBar);
        tortoise_seeBar = (SeekBar) findViewById(R.id.tortoise_seekBar);
        ...
        switch(msg.what){
                case 1:
                    rabbit_seeBar.setProgress(rabbit_count);
                    break;
            }
            if(rabbit_count>=100)
        ...
        private void runAsyncTask(){
            ...
            @Override
                ...
                tortoise_seeBar.setProgress(values[0]);
            }
            @Override
